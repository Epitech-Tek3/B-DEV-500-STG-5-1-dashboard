...
export const Information = (props: React.SVGAttributes<SVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" version="1.1" x="0px" y="0px" viewBox="0 0 60 60" {...props}>
    <g>
      <path d="M2,7H0v52c0,0.6,0.4,1,1,1h34v-2H2V7z" />
      <path d="M6,2h31v8c0,0.6,0.4,1,1,1h8v3h2v-4l0,0c0-0.1,0-0.2-0.1-0.3V9.6c-0.1-0.1-0.1-0.2-0.2-0.3l-9-9c-0.1-0.1-0.2-0.1-0.3-0.2    h-0.1C38.2,0.1,38.1,0,38,0l0,0H5C4.4,0,4,0.4,4,1v54c0,0.6,0.4,1,1,1h34v-2H6V2z M44.6,9H39V3.4L44.6,9z" />
