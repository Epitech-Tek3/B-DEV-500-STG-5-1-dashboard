...
export const FailedIllustration = (props: React.SVGAttributes<SVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 764.64 994.24" {...props}>
    <title>drawkit-grape-pack-illustration-12</title>
    <g id="Layer_2" data-name="Layer 2">
      <g id="vector">
        <path
          className="failed-cls-1"
        ...
        />
        <path
          className="failed-cls-4"
          d="M104.75,400.9c6.41-23.07,12.56-45,13.32-48.7,1.65-8,1.65-30.63,0-38.08.72-2.78,2.63-3.68,3.13-2"
        />
        <path className="failed-cls-4" d="M102.18,493c-3.92-5.52-12.81-29.3-12.81-34,0-1.77,3.88-16.38,8.79-34.28" />
        <rect
          className="failed-cls-5"
          x="121.32"
          y="54.1"
          width="489.79"
          height="437.01"
        ...
        />
        <circle className="failed-cls-5" cx="152.28" cy="167.37" r="39.59" />
        <rect
          className="failed-cls-5"
          x="121.24"
          y="226.88"
        ...
        />
        <circle className="failed-cls-7" cx="328.21" cy="264.86" r="11" />
        <rect
          className="failed-cls-6"
          x="351.13"
          y="230.94"
        ...
        />
        <circle className="failed-cls-7" cx="379.08" cy="462.73" r="11" />
        <rect
          className="failed-cls-6"
          x="402"
          y="428.82"
        ...
        />
        <line className="failed-cls-4" x1="171.36" y1="943.77" x2="220.67" y2="943.77" />
        <line className="failed-cls-4" x1="171.36" y1="951.86" x2="220.67" y2="951.86" />
        <polyline className="failed-cls-4" points="246.6 990.24 255.68 990.24 212 964.45 213.06 951.86" />
        <polyline className="failed-cls-4" points="179.85 951.86 184.69 969.4 181.28 990.24 224.91 990.24" />
        <line className="failed-cls-4" x1="50.81" y1="912.12" x2="85.64" y2="931.93" />
        <line className="failed-cls-4" x1="47.35" y1="920.86" x2="82.19" y2="940.68" />
        <polyline className="failed-cls-4" points="76.79 966.12 74.41 962.44 77.45 937.99" />
        <polyline
          className="failed-cls-4"
        ...
        />
        <path className="failed-cls-4" d="M138.7,355.79c2.51-3.36,5.29-7,5.16-12.19" />
        <path className="failed-cls-4" d="M135.38,480c-2-6.08-13.87-25.84-14.18-31-.3-5,11.52-74.88,13.66-85.65" />
        <path
          className="failed-cls-8"
        ...
        />
        <path className="failed-cls-4" d="M231.37,553.16c2.16.82,7.17,2.3,13.19,3.94" />
        <path
          className="failed-cls-4"
          d="M306.7,524.55c10.89-4,21.14-8.27,22.24-10.35,2.36-4.43,4.72-16.23,8.74-17.41s1.75,9.2,1.75,9.2"
        />
        <path className="failed-cls-4" d="M243.09,517.38c8,4.24,33.46,15.75,36.53,15.75a35.6,35.6,0,0,0,5.5-1.37" />
        <path
          className="failed-cls-8"
        ...
        />
        <path className="failed-cls-4" d="M110.3,648.59a12.13,12.13,0,0,1-2.73-1.91c-1.48-5.41-4.26-26.09-4.06-50.8" />
        <path className="failed-cls-4" d="M206.85,613.35c-1.09,12.76-2.8,25.47-5,37.59-7,2.78-32.07,4.67-54.86,3.8" />
        <path
          className="failed-cls-8"
        ...
        />
        <path className="failed-cls-4" d="M172.07,514.91a19.6,19.6,0,0,1,.67-6.5c2.72-9.82,28.9-10.64,48.44-7.15" />
        <path className="failed-cls-3" d="M172.4,502.9c0,4.07-25.8,4.59-25.8,0V466.3h25.8Z" />
        <path className="failed-cls-4" d="M168.4,487.13V498.9" />
        <path className="failed-cls-4" d="M157.79,502.08c-7.11.36-15.19-.61-15.19-3.18V462.3h25.8v16.43" />
        <ellipse className="failed-cls-3" cx="165.48" cy="439.59" rx="26.38" ry="34.69" />
        <path
          className="failed-cls-4"
        ...
        />
        <path className="failed-cls-4" d="M168.22,462.9c-1.76,5.4-4.05,9.41-6.92,9.41-4.64,0-13.16-.64-19.73-6.7" />
        <path className="failed-cls-4" d="M200,407.34c-4.81,9-16.8,19.07-23.11,24.44" />
        <path className="failed-cls-4" d="M188.48,387.58a22.07,22.07,0,0,1,6.84-1.27c5,0,6.37,4.95,6.69,10.65" />
        <path
          className="failed-cls-4"
        ...
        />
        <circle className="failed-cls-3" cx="176.37" cy="443.41" r="8.39" />
        <path className="failed-cls-4" d="M166,442.3a8.7,8.7,0,0,1,0-.89A8.38,8.38,0,0,1,178.37,434" />
        <path className="failed-cls-4" d="M176.75,449.46a8.21,8.21,0,0,1-2.38.35,8.35,8.35,0,0,1-5.79-2.32" />
        <polygon className="failed-cls-10" points="658.41 108.74 603.17 108.74 630.79 156.57 658.41 108.74" />
        <rect
          className="failed-cls-10"
          x="11.68"
          y="170.04"
          width="23.52"
          height="46.38"
        ...
        />
        <circle className="failed-cls-10" cx="379.08" cy="608.9" r="23.16" />
        <polygon className="failed-cls-5" points="691.83 491.06 687.62 577.56 764.64 537.95 691.83 491.06" />
      </g>
    </g>
  </svg>
);
